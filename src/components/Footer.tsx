...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { name: 'Email', href: 'mailto:contact@seismic-ai.com', icon: <Mail size={20} /> },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-6 gap-12">
            ...
            <div className="lg:col-span-4 grid grid-cols-2 md:grid-cols-4 gap-8">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h3 className="text-white font-semibold mb-4 font-space">Company</h3>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h3 className="text-white font-semibold mb-4 font-space">Solutions</h3>
                <ul className="space-y-2">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h3 className="text-white font-semibold mb-4 font-space">Resources</h3>
                <ul className="space-y-2">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h3 className="text-white font-semibold mb-4 font-space">Legal</h3>
                <ul className="space-y-2">
