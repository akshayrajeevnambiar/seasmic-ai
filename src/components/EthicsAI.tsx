  ...
  const principles = [
    {
      ...
      description:
        "We adhere to ethical AI principles, ensuring our models are developed with fairness, accountability, and transparency at their core.",
    },
    {
      icon: <Eye className="w-6 h-6" />,
      title: "Transparency & Explainability",
      description:
        "Our AI models provide clear reasoning for predictions, enabling users to understand and validate the decision-making process.",
    },
    {
      icon: <Database className="w-6 h-6" />,
      title: "Data Privacy & Security",
      description:
        "We implement robust data protection measures and never compromise on user privacy or confidential information security.",
    },
    {
      icon: <CheckCircle className="w-6 h-6" />,
      title: "Human-in-the-Loop",
      description:
        "AI outputs are designed to augment human expertise, not replace it. Critical decisions always require human validation and oversight.",
    },
  ];
  ...
  const dataUsage = [
    {
      type: "Training Data",
      description:
        "Anonymized seismic datasets from public repositories and partner institutions",
      status: "Compliant",
    ...
    },
    {
      type: "User Data",
      description:
        "Processed on-premise or in secure cloud environments with encryption",
      status: "Protected",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-muted max-w-3xl mx-auto font-inter leading-relaxed">
            Our commitment to responsible AI development and transparent
            practices in geophysical modeling
          </p>
        </motion.div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-300 font-inter leading-relaxed">
                <strong>
                  All AI outputs are for informational purposes only
                </strong>{" "}
                and must be validated by qualified geophysicists. Our models
                provide intelligent assistance but cannot replace professional
                geological interpretation, field validation, or expert judgment.
                Users are responsible for verifying all AI-generated predictions
        ...
        >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h4 className="text-white font-semibold mb-4 font-space">
              Your Data Rights
            </h4>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h5 className="text-neon font-medium mb-2 font-inter">
                  Data Control
                </h5>
                <p className="text-muted font-inter text-sm leading-relaxed">
                  You maintain full control over your data. We provide options
                  to review, modify, or delete your information at any time.
                </p>
              </div>
              <div>
                <h5 className="text-neon font-medium mb-2 font-inter">
                ...
                <p className="text-muted font-inter text-sm leading-relaxed">
                  ...
                  to opt-out of data processing or request data removal.
                </p>
              </div>
            </div>
          </motion.div>
