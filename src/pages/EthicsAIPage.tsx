          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Our commitment to responsible AI development, ethical
                principles, and transparent practices that prioritize human
                benefit, fairness, and accountability.
              </p>
              ...
              <div>
                ...
                <Section id="principles" title="Our Ethics Principles">
                  <p className="text-gray-300 leading-relaxed text-lg mb-6">
                    We build AI systems that are useful, safe, and fair by
                    design. Our principles guide every decision in the
                    development, deployment, and maintenance of our AI
                    technologies.
                  </p>
                ...
                <Section
                  id="fairness-bias"
                  title="Fairness, Bias & Representativeness"
                >
                  <div className="space-y-6">
                    <div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border border-yellow-500/20 rounded-xl p-6">
                      ...
                      <p className="text-gray-300 text-sm leading-relaxed">
                        We implement comprehensive bias detection and mitigation
                        strategies throughout the AI development lifecycle, from
                        data collection to model deployment and ongoing
                        monitoring.
                      </p>
                    </div>
                ...
                <Section
                  id="explainability"
                  title="Explainability & Model Transparency"
                >
                  <div className="space-y-6">
                    {[
                      {
                      ...
                      <div
                        key={index}
                        className="flex items-start space-x-4 bg-white/[0.02] border border-white/[0.08] rounded-xl p-6"
                      >
                        <div className="text-[#00E5FF] mt-1">{item.icon}</div>
                        <div>
                          <h4 className="text-white font-semibold mb-2 font-space">
                            {item.title}
                          </h4>
                ...
                <Section
                  id="safety"
                  title="Safety, Red-Team & Abuse Prevention"
                >
                  <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-6 mb-6">
                    ...
                    <p className="text-gray-300 text-sm leading-relaxed">
                      We implement multiple layers of safety controls to prevent
                      misuse and ensure responsible deployment of our AI systems
                ...
                <Section
                  id="security"
                  title="Security & Infrastructure Controls"
                >
                  <div className="grid md:grid-cols-2 gap-6">
                    {[
                      {
                ...
                <Section id="environment" title="Environmental Stewardship">
                  <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-6 mb-6">
                    ...
                    <p className="text-gray-300 text-sm leading-relaxed">
                      We actively measure and minimize the environmental impact
                      of our AI systems throughout their lifecycle, from
                ...
                <Section
                  id="evaluations"
                  title="Evaluation Frameworks & Benchmarks"
                >
                  <div className="space-y-6">
                    <p className="text-gray-300 leading-relaxed">
                      We employ comprehensive evaluation frameworks to ensure
                      our AI systems meet high standards for accuracy, fairness,
                      robustness, and usability before deployment.
                    </p>
                    ...
                    <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-6">
                      ...
                      <p className="text-gray-300 text-sm leading-relaxed">
                        Models must meet or exceed baseline metrics, bias
                        thresholds, safety tests, and latency SLOs before being
                ...
                <Section
                  id="customer-controls"
                  title="Customer Controls & Transparency Tools"
                >
                  <div className="space-y-6">
                    <p className="text-gray-300 leading-relaxed">
                      We provide customers with comprehensive tools and controls
                      to manage their data, understand AI decisions, and
                      maintain compliance with their organizational policies.
                    </p>
                ...
                <Section id="incidents" title="Incident Response & Reporting">
                  <div className="bg-orange-500/10 border border-orange-500/20 rounded-xl p-6 mb-6">
                    ...
                    <p className="text-gray-300 text-sm leading-relaxed">
                      We maintain comprehensive incident response capabilities
                      with defined escalation procedures and transparent
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      <div
                        key={index}
                        className="border-l-2 border-orange-500/30 pl-6"
                      >
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid gap-4">
                      {[
                        ...
                        <div
                          key={index}
                          className="flex items-center space-x-3 bg-white/[0.02] border border-white/[0.08] rounded-lg p-4"
                        >
                  ...
                  <div className="space-y-8">
                    {[
                      ...
                      <div key={index} className="space-y-4">
                        <h4
                          className={`text-xl font-semibold font-space ${
                            phase.color === "green"
                              ? "text-green-400"
                              : phase.color === "blue"
                              ? "text-blue-400"
                        ...
                        <div className="grid gap-3">
                          {phase.items.map((item, itemIndex) => (
                            <div
                              key={itemIndex}
                              className={`flex items-start space-x-3 bg-${phase.color}-500/10 border border-${phase.color}-500/20 rounded-lg p-4`}
                            >
                              <div
                                className={`w-2 h-2 bg-${phase.color}-400 rounded-full mt-2 flex-shrink-0`}
                              ></div>
                      ...
                      <div className="space-y-4">
                        ...
                        {brandName === "Seismic AI" && (
                          <p className="text-gray-400 text-sm">
                            For Turbo AI deployments, contact
                            support@turbo-ai.ca
                            <br />
                            Brand-specific artifacts (model cards, disclosures)
                            are available per customer contract.
                          </p>
                        )}
                      </div>
                    </div>
